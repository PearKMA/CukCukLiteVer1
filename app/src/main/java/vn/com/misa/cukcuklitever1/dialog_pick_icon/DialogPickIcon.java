...
import vn.com.misa.cukcuklitever1.dialog_pick_color.PickColorAdapter;

public class DialogPickIcon extends DialogFragment  {
    private RecyclerView rvPickColor;
    private TextView tvCancel;
    //private PickIconAdapter mAdapter;
    private ArrayList<String> mListColor;


    public static DialogPickIcon newInstance(String color) {
        Bundle args = new Bundle();
        args.putString("Color",color);
        DialogPickIcon fragment = new DialogPickIcon();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments()!=null) {
            //mAdapter = new PickIconAdapter(getActivity(), mListColor,getArguments().getString("Color","#039be5"));
